	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading dark-primary-color">
				<h1 class="text-center text-primary-color"><?php echo e($auction->auctionname); ?></h1>
			</div>
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-6">
										...
										<?php if(auth()->check()): ?>
										<?php if($auction->user->id==auth()->user()->id): ?>
									...
									<div class="col-md-6" style="border-left:1px dashed black">
										...
										<p>Started On: <?php echo e($auction->startdate->toDayDateTimeString()); ?></p>
