<div class="navbar navbar-default navbar-fixed-top" role="navigation">  
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav pull-right">
                ...
                <li><a href="<?php echo e(asset('helpfile/BestBidHelp.pdf')); ?>">Help</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="<?php echo e(url('/admindash/users')); ?>">Users</a></li>
                    </ul>
                    <?php endif; ?>
                    <li><a href="" data-target="#notifications" data-toggle="modal">Notifications (<?php echo e(auth()->user()->notification_count); ?>)</a></li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"> My BestBid (<?php echo e(Auth::user()->firstname); ?>) <span class="caret"></span>  
                        </a>
                        <ul class="dropdown-menu" role="menu">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav" >
                    ...
                    <li class="<?php echo e(Request::is('ending-soon') ? 'active' : ''); ?>"><a href="<?php echo e(url('/endingsoon')); ?>">Ending Soon</a></li>
    ...
    <?php echo $__env->make('partitions.notifications', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <div class="container">