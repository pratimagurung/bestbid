...
<div class="container">          
	<table class="table table-striped">
		...
		<tbody>
			...
			<tr>
				<td><a href="<?php echo e(url('/auction/'.$product->auction->id)); ?>"><?php echo e($product->auction->product->productname); ?><br><img class="img-responsive" height="200px" width="200px" src="<?php echo e(asset('images/uploads/'.$product->auction->product->picturename)); ?>"></a></td>
				<td><?php echo e($product->auction->product->description); ?></td>
