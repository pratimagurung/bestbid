<?php $__env->startSection('title','Search Auction'); ?>
...
<div class="container">          
	<table class="table table-striped">
		...
		<tbody>
			...
			<tr>
				<td><a href="<?php echo e(url('/auction/'.$auction->id)); ?>"><?php echo e($auction->product->productname); ?></a></td>
				<td><?php echo e($auction->product->description); ?></td>
				<td><?php echo e(count($auction->bids)); ?></td>
				<td><?php echo e($auction->current_price); ?></td>
				<td><?php echo e($auction->enddate->diffForHumans(null,true)); ?> remaining</td>
			</tr>
			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
		</tbody>
	</table>
	<?php echo e($auctions->appends(Request::only('searchTerm'))->links()); ?>
