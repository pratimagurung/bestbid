...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
	...
	<div class="carousel-inner">
		<div class="item active">
			<img class="img-responsive" src="images/pic/bid.jpg">
		...
		<div class="item">
			<img class="img-responsive" src="images/pic/images.jpg">
			<div class="carousel-caption">
				<h3></h3>
				<p>Lets Bid!</p>
			</div>
		...
		<div class="item">
			<img class="img-responsive" src="<?php echo e(asset('images/pic/bb.jpg')); ?>">
			<div class="carousel-caption">
				<h3></h3>
				<p>Hurry Up!</p>
			</div>
	...
	<div class="row"> 
		...
		<div class="col-md-4">
			<div class="well">
				...
				<br>
				<p class="text-center">
					<?php echo e($auction->enddate->diffForHumans()); ?>
